...
class NeuroScanEEGThread(threading.Thread,):
    ...
    def readFixedData(self, startPoint, length):
        ...
        while self.eventExist is True:
            ...
            return data if self.keepEvent == True else data,eventType
        else:
            return None
    ...
    def _initFilter(self):
        ...
        # band pass
        b, a = signal.butter(N=5, Wn=50, fs=fs, btype='lowpass')
        bp = [b, a]
        ...
        if self.event is not None:
            ...
            if eventType <100:
                ...
                if self.keepEvent == False:
                    ...
                    elist = [point, packageINX,eventType]

                self.eventPoint.appendleft(elist)
                self.event = None
